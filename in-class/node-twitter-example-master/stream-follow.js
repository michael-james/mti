...
// set up a stream
var streamer = client.stream('statuses/filter', {follow: "25073877,822215679726100480"});


streamer.on('data', function(tweet) {

	if (tweet.user != null && tweet.user.screen_name == "realDonaldTrump" || tweet.user.screen_name == "POTUS") {
